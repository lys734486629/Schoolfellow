...
.grayr span.disabled {padding:2px 5px;margin:2px;color:#797979;background: #c1c1c1;border:1px #c1c1c1 solid;}
  ...
  欢迎您:<%=session.getAttribute("username") %>
      ...
      <!--<th>
                         <tr>
                              <th width="130" style="color:black"><div align="center">学号</div></th>
                              <th width="130" style="color:black"><div align="center">学院</div></th>
                              <th width="130" style="color:black"><div align="center">专业</div></th>
...
<% ArrayList<UserBean> userlist1=(ArrayList<UserBean>)session.getAttribute("userlist1");
    ...
    int i=0;
                              for(i=0;i<userlist1.size();i++)
                                {         fs1=userlist1.get(i);
							    out.print("<tr>");
							    out.print("<td>"+fs1.getNumber()+"</td>");
							    out.print("<td>"+fs1.getCollege()+"</td>");
							    out.print("<td>"+fs1.getMajor()+"</td>");
