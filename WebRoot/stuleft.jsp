...
.menu_head { padding: 5px 35px; cursor: pointer; position: relative; margin:2px; background: #EDEDEC url(images/left.png) center right no-repeat; }
...
.menu_body a:hover { color: #000000; text-decoration:underline; }
  ...
  <div id="firstpane" class="menu_list">
    ...
    <p class="menu_head">查看就业信息</p>
    <div class="menu_body"> <a href="major.jsp" style="height:40px" target="main">就业信息</a> </div>
