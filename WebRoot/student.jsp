...
function tick(){
	...
	<%String current; %>
       ...
       <p>
    <a href="major.jsp" target="right">查看就业信息
		</a>
		</p>
...
[today.getDay()] +","+"</div>");
	  ...
	  <td colspan="4">
		...
		<td colspan="2" background="images/adminmoban_13.gif" height="33"><div class="d1"><a href="student.jsp" style="font-size:12">网站首页</a></div></td>
		<td width="16">
	...
	<tr>
		<td colspan="3" rowspan="3" background="images/adminmoban_18.gif" width="200" height="464"><iframe src="stuleft.jsp" width="200" height="464" frameborder="0" scrolling="no"></iframe></td>
		<td>
