...
.menu_body a:hover { color: #000000; text-decoration:underline; }
  ...
  <div id="firstpane" class="menu_list">
    ...
    <p class="menu_head">查看全部学生信息</p>
    <div class="menu_body"> <a href="./servlet/SearchAllservlet?current=1" style="height:40px;" target="main">全部学生信息</a>
    </div>
    <p class="menu_head">查看全部校友信息</p>
    <div class="menu_body"> <a href="./servlet/SearchAllservlet?current=2" style="height:40px" target="main">全部校友信息</a> </div>
    <p class="menu_head">查看全部工作信息</p>
    <div class="menu_body"> <a href="./servlet/SearchAllservlet?current=3" style="height:40px;" target="main">全部工作信息</a>
    </div>
    <p class="menu_head">统计不同工作年限后的平均工资</p>
    <div class="menu_body"> <a href="count.jsp" style="height:40px;" target="main">平均工资</a>
    </div>
  </div>
