...
function tick(){
	...
	<%String current; %>
	     <p>
		<a href="./servlet/SearchAllservlet?current=1" target="right">查看全部学生信息
		</a>
		</p>
		<p>
		<a href="./servlet/SearchAllservlet?current=2" target="right">查看全部校友信息
		</a>
		</p>
		<p>
		<a href="./servlet/SearchAllservlet?current=3" target="right">查看全部工作信息
		</a>
		</p>
		<p>
		<a href="count.jsp" target="right">统计不同工作年限后的平均工资
		</a>
		</p>-->
...
[today.getDay()] +","+"</div>");
	  ...
	  <td colspan="4">
		...
		<td colspan="2" background="images/adminmoban_13.gif" height="33"><div class="d1"><a href="manager.jsp" style="font-size:12">网站首页</a></div></td>
		<td width="16">
	...
	<tr>
		<td colspan="3" rowspan="3" background="images/adminmoban_18.gif" width="200" height="464"><iframe src="adminleft.jsp" width="200" height="464" frameborder="0" scrolling="no"></iframe></td>
		<td>
